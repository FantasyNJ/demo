...
function createTr(obj){
    ...
    function addEvent(i){
        ...
        var oInp = tr.cells[i].getElementsByTagName('input')[0];  //输入框
        var oDiv = tr.cells[i].getElementsByTagName('div')[0];
        var aBtn = oDiv.getElementsByTagName('span');   //√ X 按钮
        tr.cells[i].ondblclick = function(){
            this.children[1].children[0].value = this.children[0].innerHTML;
